...
const HOME_QUICK_CHIP_DISH_POOL = [
  ...
  "Poké bowl",
  "Ovenschotel",
  "Spaghetti Bolognese (Klassieker)",
  "Pasta Carbonara (Echt, met ei)",
  "Lasagne Bolognese",
  "Pasta Pesto",
  "Macaroni and Cheese",
  "Tomatenrisotto met Parmezaan en citroen",
  "Gnocchi met salieboter",
  "Pizza Margherita (Zelfgemaakt)",
  "Pasta met feta uit de oven (Tiktok-trend)",
  "Fettuccine Alfredo",
  ...
  "Babi Pangang (Surinaams/Chinees-Indisch)",
  "Snert (Erwtensoep)",
  "Thaise Pad Thai",
  "Massaman Curry",
